...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /local-scratch/xlv/reward_shaping_ttr/catkin_ws/src/turtlebot_simulator/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /local-scratch/xlv/reward_shaping_ttr/catkin_ws/devel/.private/turtlebot_gazebo)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /local-scratch/xlv/reward_shaping_ttr/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-scratch/xlv/reward_shaping_ttr/catkin_ws/src/turtlebot_simulator/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /local-scratch/xlv/reward_shaping_ttr/catkin_ws/devel/.private/turtlebot_gazebo/lib;/local-scratch/xlv/reward_shaping_ttr/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
