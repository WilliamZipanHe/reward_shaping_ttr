...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /local-scratch/xlv/reward_shaping_ttr/catkin_ws/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /local-scratch/xlv/reward_shaping_ttr/catkin_ws/devel/.private/tf2)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /local-scratch/xlv/reward_shaping_ttr/catkin_ws/install)
...
if(NOT "/local-scratch/xlv/reward_shaping_ttr/catkin_ws/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/local-scratch/xlv/reward_shaping_ttr/catkin_ws/src/geometry2/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/local-scratch/xlv/reward_shaping_ttr/catkin_ws/src/geometry2/tf2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /local-scratch/xlv/reward_shaping_ttr/catkin_ws/devel/.private/tf2/lib;/local-scratch/xlv/reward_shaping_ttr/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
